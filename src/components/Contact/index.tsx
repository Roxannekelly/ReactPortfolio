  ...
  return (
    <div className="bg-hero text-white">
      ...
      <div className="mx-4 my-6  lg:px-56 lg:py-10">
        ...
        <input
          className="bg-gray-200 border my-6 border-gray-300 text-gray-900 text-sm rounded-2xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        <textarea
          className="border-2 w-full my-4 rounded-2xl"
          name=""
          id=""
          cols={30}
          rows={10}
